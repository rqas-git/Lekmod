...
#define OBSERVER_TEAM											((TeamTypes)(MAX_MAJOR_CIVS-1))

#define MAX_DAMAGE_MEMBER_COUNT								32
#define CVHEADER_VERSIONING_STARTED							7
...
const char* const CIV5_XP1_SCENARIO1_MODID = "8f9d820d-e336-4208-891d-50fdd968cc40";
const char* const CIV5_XP1_SCENARIO2_MODID = "76d702e9-8b28-429b-a97d-f84388f548c5";
const char* const CIV5_XP1_SCENARIO3_MODID = "b103d2e0-3aab-40d7-a2f3-375d2eabfcaf";

const char* const CIV5_DLC_06_PACKAGEID = "BBB0D085-A0B1-4475-B007-3E549CF3ADC3";

const char* const CIV5_XP2_SCENARIO1_MODID = "55fd836a-72e5-4aba-bbcf-3395b05a0e70";
const char* const CIV5_XP2_SCENARIO2_MODID = "f2eb1642-3334-4d2c-8db1-08e6aede3532";

const char* const CIV5_COMPLETE_SCENARIO1_MODID = "34fb6c19-10dd-4b65-b143-fd00b2c0826f";
